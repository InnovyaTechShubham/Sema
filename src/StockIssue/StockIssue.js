        ...
        onSubmit: (values, action) => {
            ...
            try {
                ...
                const loadUsers = async () => {
                    setLoading(true);
                    const remainingquanity = maxquantity - values.quantityissued;
                    ...
                    const res = await axios.put('http://localhost:4000/stocks/'+stockid, {
            ...
            alert("Please Enter Quantity less than Maximum Quantity")
        }
        },
    });
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <input
                                                                ...
                                                                name="quantityissued"
                                                                className="form-control"
                                                                placeholder={"Max Quantity possible : "+maxquantity}
